    ...
    return (
        <div className='flex flex-col max-w-[1200px] mx-auto items-center justify-between py-20 space-y-5'>
            ...
            <div className='flex items-center bg-gray-100 rounded-full p-1 w-fit'>
                ...
                <button onClick={() => setActiveButton("cart")} className={`${activeButton === "cart" ? "cursor-pointer bg-gradient-to-r from-[#4F39F6] to-[#9514FA] px-6 py-2 rounded-full font-semibold text-white shadow-md" : "cursor-pointer px-6 py-2 rounded-full text-gray-600 font-medium"} `}>Cart</button>
